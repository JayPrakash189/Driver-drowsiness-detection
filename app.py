...
def check_distraction(lm):
    ...
    horiz_offset = nose.x - face_center_x
    vert_offset  = nose.y - face_center_y
...
with st.sidebar:
    ...
    ear_thr = st.slider("EAR Threshold", 0.10, 0.35, 0.20, 0.01,
        help="Eye closed if EAR drops BELOW this.")
    jaw_thr = st.slider("JAW Threshold", 0.10, 0.70, 0.30, 0.01,
        help="Yawn if jawOpen score is ABOVE this.")
